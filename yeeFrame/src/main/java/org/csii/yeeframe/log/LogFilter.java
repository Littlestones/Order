...
public abstract class LogFilter {
     ...
     * @return
     */
    public abstract boolean filter(YeeLog.LEVEL level, String tag, String msg);
    ...
    public static class TagFilter extends LogFilter {
        ...
        @Override
        public boolean filter(YeeLog.LEVEL level, String tag, String msg) {
    ...
    public static class LevelFilter extends LogFilter {
        private YeeLog.LEVEL level = null;
         ...
         */
        public LevelFilter(YeeLog.LEVEL level) {
            if (level == null) {
