 ...
 */
package org.csii.yeeframe.log;

import android.content.Context;
import android.text.TextUtils;

import org.csii.yeeframe.log.time.FastDateFormat;
 ...
 * 
 * Created by DuMing on 2015.10.27.
 */
public abstract class FilePathGenerator {
    private String path = null;
    protected String dir = "/mnt/sdcard/csii/android/log";
    ...
    /**
     * dir will be context.getExternalFilesDir("null").getAbsolutePath() + File.separator + "csii" + File.separator + "log"
    ...
    public FilePathGenerator(Context context, String filename, String suffix) {
        ...
        dir = context.getExternalFilesDir(null).getAbsolutePath() + File.separator + "csii" + File.separator + "log";
