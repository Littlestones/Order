...
public class NetworkDispatcher extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            } catch (YeeHttpException volleyError) {
                parseAndDeliverNetworkError(request, volleyError);
            } catch (Exception e) {
                YeeLoger.debug("Unhandled exception %s", e.getMessage());
                mDelivery.postError(request, new YeeHttpException(e));
            }
        }
    }

    private void parseAndDeliverNetworkError(Request<?> request,
            YeeHttpException error) {
