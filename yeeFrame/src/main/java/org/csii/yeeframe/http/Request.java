...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    protected YeeHttp mRequestQueue;
    ...
    public void finish(final String tag) {
        ...
        if (requestTime >= SLOW_REQUEST_THRESHOLD_MS) {
            YeeLoger.debug("%d ms: %s", requestTime, this.toString());
        }
    }

    public Request<?> setRequestQueue(YeeHttp requestQueue) {
     ...
     */
    protected YeeHttpException parseNetworkError(YeeHttpException volleyError) {
        return volleyError;
    }
     ...
     *            原因
     */
    public void deliverError(YeeHttpException error) {
        if (mCallback != null) {
            int errorNo;
            String strMsg;
            if (error != null) {
