/*
 * Copyright (C) 2011 The Android Open Source Project,CSII
 *
...
public class Network {
    ...
    public NetworkResponse performRequest(Request<?> request)
        ...
        while (true) {
            ...
            try {
                ...
                throw new YeeHttpException(new SocketTimeoutException(
                        "socket timeout"));
                ...
                if (httpResponse != null) {
                    ...
                    throw new YeeHttpException("NoConnection error", e);
                }
                YeeLoger.debug("Unexpected response code %d for %s", statusCode,
                        request.getUrl());
                if (responseContents != null) {
                    ...
                    if (statusCode == HttpStatus.SC_UNAUTHORIZED
                        ...
                        throw new YeeHttpException("auth error");
                    } else {
                        throw new YeeHttpException(
                                "server error, Only throw ServerError for 5xx status codes.",
                                networkResponse);
                    }
                } else {
                    throw new YeeHttpException(networkResponse);
                }
            }
        }
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException,
        ...
        try {
            ...
            if (in == null) {
                throw new YeeHttpException("server error");
            }
            ...
            try {
                ...
                YeeLoger.debug("Error occured when calling consumingContent");
            }
