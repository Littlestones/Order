...
import org.csii.yeeframe.http.HttpHeaderParser;
import org.csii.yeeframe.http.YeeHttpException;
import org.csii.yeeframe.http.NetworkResponse;
import org.csii.yeeframe.http.Request;
import org.csii.yeeframe.http.Response;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        synchronized (sDecodeLock) {
            try {
                ...
                YeeLoger.debug("Caught OOM for %d byte image, url=%s",
                        response.data.length, getUrl());
                return Response.error(new YeeHttpException(e));
            }
        }
    }
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            return Response.error(new YeeHttpException(response));
        } else {
