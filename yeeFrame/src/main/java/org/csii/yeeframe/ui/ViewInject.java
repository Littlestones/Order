...
public class ViewInject {
    ...
    public static void toast(String msg) {
        try {
            toast(YeeActivityStack.create().topActivity(), msg);
        } catch (Exception e) {
        }
    }
    ...
    public static void longToast(String msg) {
        try {
            longToast(YeeActivityStack.create().topActivity(), msg);
        } catch (Exception e) {
        }
    }
    ...
    public void getDateDialog(String title, final TextView textView) {
        final String[] time = YeeUtilsSystem.getDataTime("yyyy-MM-dd").split("-");
        final int year = YeeUtilsString.toInt(time[0], 0);
        final int month = YeeUtilsString.toInt(time[1], 1);
        final int day = YeeUtilsString.toInt(time[2], 0);
    ...
    public static ProgressDialog getprogress(Activity aty, String msg,
        ...
        progressDialog.getWindow().setLayout(YeeUtilsDensity.getScreenW(aty),
                YeeUtilsDensity.getScreenH(aty));
