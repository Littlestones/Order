 ...
 * @version 1.0
 */
public class YeeViewPager extends ViewGroup {
    ...
    public YeeViewPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YeeViewPager(Context context, AttributeSet attrs, int defStyle) {
