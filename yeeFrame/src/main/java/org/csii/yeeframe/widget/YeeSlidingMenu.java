 ...
 */
package org.csii.yeeframe.widget;
 ...
 * @author yee.zh
 */
public class YeeSlidingMenu extends HorizontalScrollView {
    ...
    public YeeSlidingMenu(Context context) {
        this(context, null, 0);
    }

    public YeeSlidingMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YeeSlidingMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mScreenWidth = YeeUtilsDensity.getScreenW(context);
