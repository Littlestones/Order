 ...
 */
package org.csii.yeeframe.database;

import java.util.HashMap;
import java.util.Map.Entry;

import org.csii.yeeframe.YeeDB;
import org.csii.yeeframe.database.utils.ManyToOne;
import org.csii.yeeframe.database.utils.OneToMany;
import org.csii.yeeframe.database.utils.Property;
...
public class CursorHelper {
     ...
     * @return
     */
    public static <T> T getEntity(Cursor cursor, Class<T> clazz, YeeDB db) {
        try {
            if (cursor != null) {
                // 读取表信息
